...
# example: /home/jtc/Downloads *(rw,sync,no_root_squash,no_subtree_check)
^x
sudo exportfs -ra
...
# example: sudo mount -t nfs -o nolock,nfsvers=3 10.100.70.138:/home/jtc/Downloads /mnt/sar_data
```