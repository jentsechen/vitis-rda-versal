...
TILE_S2MM = ./hls/tile_s2mm/tile_s2mm.xo
...
${XSA}: ${MM2S} ${S2MM} ${TILE_S2MM} ${TILE_TRANSPOSE} ${LIBADF} ${VPP_SPEC} 
	${VCC} -l -g --platform ${PLATFORM} ${MM2S} ${S2MM} ${TILE_S2MM} ${TILE_TRANSPOSE} ${LIBADF} \
...
# 	$(MAKE) -C sw/
${HOST_EXE}: ${GRAPH} ./Work/ps/c_rts/aie_control_xrt.cpp ./sw/host.cpp ./sw/range_fft.cpp
	$(MAKE) -C sw/
